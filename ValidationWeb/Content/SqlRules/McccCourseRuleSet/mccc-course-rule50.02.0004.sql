...
When Course grade level offered are within grades 9-12, If D is selected, then NOT B, E, G, X

*/

DECLARE @RuleId VARCHAR(32) = '50.02.0004';
DECLARE @Message NVARCHAR(MAX) = 'Course level type combination error detected for course offered for grades 9-12. if course level type D is selected for the course, B, E, G, or X cannot also be selected on the same course.';
