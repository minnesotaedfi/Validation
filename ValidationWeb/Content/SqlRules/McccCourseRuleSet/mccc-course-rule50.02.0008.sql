...
When Course grade level offered are within grades 9-12, If X is selected, then NOT A, B, C, D, E, G, N

*/

DECLARE @RuleId VARCHAR(32) = '50.02.0008';
DECLARE @Message NVARCHAR(MAX) = 'Course level type combination error detected for course offered for grades 9-12. if course level type X is selected for the course, A, B, C, D, E, G, or N cannot also be selected on the same course.';
