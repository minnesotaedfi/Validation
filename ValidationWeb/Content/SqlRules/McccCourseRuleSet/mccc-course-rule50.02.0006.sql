...
When Course grade level offered are within grades 9-12, If G is selected, then NOT A, B, C, D, E, X

*/

DECLARE @RuleId VARCHAR(32) = '50.02.0006';
DECLARE @Message NVARCHAR(MAX) = 'Course level type combination error detected for course offered for grades 9-12. if course level type G is selected for the course, A, B, C, D, E, or X cannot also be selected on the same course.';
