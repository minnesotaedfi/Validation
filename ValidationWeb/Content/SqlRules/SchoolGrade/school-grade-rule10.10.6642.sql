DECLARE @RuleId NVARCHAR(50) = '10.10.6642';
DECLARE @RuleDescription NVARCHAR(MAX) = '429. The MARSS Enrollment data reported for this school would indicate this is an Elementary school (no students reported in grades 7 or above), but the grades registered in MDEORG conflict with this designation for accountability purposes. Check the grade levels that are authorized for this school in MDEORG.';
...
StudentGradeLevel NOT IN ('7', '8', '9', '10', '11', '12') AND 
