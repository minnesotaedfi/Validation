...
Error on: Invalid response for Internet Access Type In Residence for this student
...
DECLARE @Message NVARCHAR(MAX) = 'Invalid response for Internet Access Type In Residence for this student.
