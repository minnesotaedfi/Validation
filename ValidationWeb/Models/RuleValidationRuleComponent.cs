...
namespace ValidationWeb
{
    ...
    /// For each rule in the collection, each time the collection is run, one instance of RuleValidationRuleComponent will be created to track the running of that rule's validation during this particular execution of the Rules Engine.
    /// </summary>
